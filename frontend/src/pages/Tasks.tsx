...
const Tasks: React.FC = () => {
  ...
  // Demo fallback data (used if backend is unavailable)
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (mounted && res?.data?.tasks) setTasks(res.data.tasks);
      } catch (err) {
        console.warn('Could not fetch tasks from API, using demo data', err);
        if (mounted) setTasks(demoTasks);
      } finally {
